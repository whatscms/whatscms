...
<head>
	...
	<meta name="keywords" content="得鹿云商,开源商城系统,微信小程序">
	<meta name="description" content="得鹿云商开源系统是一款基于LeanCloud开发的小程序，包括分类、购物车、微信登录、微信支付、收货地址、评价等基本模块">
	<style>
		/*分隔线*/
		.line {
			border: none;
	  ...
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav" style="margin-left: 400px;">
	        ...
	        <li><a id="service" href="http://www.delu360.com">关于我们</a></li>
	      </ul>
	    </div>
	  </div>
	</nav>
